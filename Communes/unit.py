...
class unit :
    def __init__(self, nameI, ids,domain, uri="", dep="") :
        self.name=nameI
        self.ids=ids
    ...
    def addVersion(self, nameI, startDate, level, geometry, endDate=2023):
        self.version.append(version(nameI, startDate, level, self.uriBase, geometry, endDate))
    ...
    def getIntersectingVersions(self, start, end):
        r=[]
        for v in self.versions :
            if (v.startDate<=start and v.startDate>=end) or (v.endDate<=start and v.endDate>=end) :
                r.append(v)
        return r
...
class version :
    def __init__(self, nameI, startDate, level, uriBase, endDate=0) :
        self.name=nameI
    ...
    def __init__(self, nameI, startDate, level, uriBase, geometry, endDate=0) :
        self.name=nameI
        self.startDate=startDate
        self.endDate=endDate
        self.level=level
